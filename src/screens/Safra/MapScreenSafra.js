...
export default function MapScreenSafra({ route, navigation }) {
    ...
    const {descriptionSafra, dateStartSafra, dateEndSafra, observationSafra, descriptionCulture, dateStartCulture, observationCulture} = route.params
    console.log(descriptionSafra, dateStartSafra, dateEndSafra, observationSafra, descriptionCulture, dateStartCulture, observationCulture)
    ...
    let safra = await firebase.database().ref(`users/${uid}/safra`)
    let pk = descriptionSafra
    safra.child(pk).set({
    ...
    Alert.alert(
        "Parabéns!",
        "Sua safra foi cadastrada com sucesso.",
        [
